...
@Entity
@Table(name="rh_shift_detail2")
public class RhShiftDetail2 implements Serializable{
	...
	public String getTimeStartString() {
		DateTime dateTime =  new DateTime(this.timeStart);
		timeStartString = dateTime.getMonthOfYear() + "-" + dateTime.getDayOfMonth();
